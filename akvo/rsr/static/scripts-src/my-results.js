            ...
            if (isNaN(updateValue) || isNaN(originalValue)) {
                ...
                return (
                    React.DOM.div( {className:"upActualValue"}, 
                        ...
                        React.DOM.span( {className:"update-actual-value-data"}, this.state.value),React.DOM.br(null)
                    )
                );
            } else {
                ...
                return (
                    React.DOM.div( {className:"upActualValue"}, 
                        React.DOM.span( {className:"update-actual-value-text"}, label,": " ),
                        React.DOM.span( {className:"update-actual-value-data"}, displayNumber(updateValue), " " ),
                        React.DOM.span( {className:"update-relative-value"}, "(",valueChangeText,")")
                    )
                );
            }
        },
                ...
                return (
                    React.DOM.div( {className:"row"}, 
                        React.DOM.div( {className:"col-xs-6"}, 
                            ...
                            React.DOM.input( {className:"form-control", id:inputId, defaultValue:this.state.value, onChange:this.handleDataChange, placeholder:i18nResults.input_placeholder} )
                        ),
                        React.DOM.div( {className:"col-xs-6"}, 
        ...
        render: function() {
            ...
            if (this.props.selectedResult !== null && this.props.selectedResult.indicators !== undefined && this.props.selectedResult.indicators.length === 0) {
                ...
                if (isAdmin || isMEManager) {
                    var language = window.location.pathname.substring(0, 3);
                    addIndicatorsLink =
                        React.DOM.a( {href:language + "/myrsr/project_editor/" + projectId + "/"}, i18nResults.add_indicators);
                } else {
